...
export const zh = {
  ...
  "funding.para_1": "理科迷致力于收支平衡后的可持续发展。",
  "funding.para_2": "平台运行至今，由管理团队自费支撑服务器、域名等运营成本。",
  "funding.para_3": "我们计划在平台稳定运营后启动正式资助系统。",
  "funding.costs_title": "关于运营成本",
  "funding.cost_server": "服务器与域名费用",
